...
export function getHowToBuyVignetteSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  const content = {
    bg: {
 ...
 */
export function getHowToCheckVignetteSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  const content = {
    bg: {
