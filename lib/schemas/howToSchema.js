...
export function getHowToBuyVignetteSchema(locale = 'bg', baseUrl = 'https://vinetka.bg') {
  const content = {
    bg: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: "Веднага след успешно плащане ще получите потвърждение на предоставения имейл адрес. Винетката се активира автоматично в системата на НК 'Автомагистрали'. Не е необходимо да поставяте нищо на стъклото на автомобила - системата разпознава винетката автоматично чрез камери.",
 ...
 */
export function getHowToCheckVignetteSchema(locale = 'bg', baseUrl = 'https://vinetka.bg') {
  const content = {
    bg: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: "Системата ще покаже моментално дали имате валидна винетка, типа ѝ и периода на валидност. Информацията е синхронизирана в реално време с базата данни на НК 'Автомагистрали'.",
