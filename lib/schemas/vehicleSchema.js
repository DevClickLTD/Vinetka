 ...
 */
export function getVehicleCategorySchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
 ...
 */
export function getVehicleOfferCatalogSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  const categories = vehicleCategories[locale] || vehicleCategories.bg;
