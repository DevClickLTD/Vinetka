 ...
 */
export function getVehicleCategorySchema(locale = 'bg', baseUrl = 'https://www.vinetka.bg') {
 ...
 */
export function getVehicleOfferCatalogSchema(locale = 'bg', baseUrl = 'https://www.vinetka.bg') {
  const categories = vehicleCategories[locale] || vehicleCategories.bg;
