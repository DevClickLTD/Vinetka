 ...
 */
export function getVehicleCategorySchema(locale = 'bg', domain = 'avtovia') {
 ...
 */
export function getVehicleSchema(vehicleType, locale = 'bg', domain = 'avtovia') {
  const siteUrl = getSiteUrl(domain);
  const vehicleData = {
    car: {
      bg: {
 ...
 */
export function getVehicleOfferCatalogSchema(locale = 'bg', domain = 'avtovia') {
  const siteUrl = getSiteUrl(domain);
  const categories = vehicleCategories[locale] || vehicleCategories.bg;
