 ...
 */
export function getGovernmentServiceSchema(locale = 'bg') {
 ...
 */
export function getVignetteCheckPublicServiceSchema(locale = 'bg') {
  const siteUrl = 'https://www.avtovia.bg';
  return {
    "@context": "https://schema.org",
    "@type": "PublicService",
 ...
 */
export function getVignetteCheckSoftwareSchema(locale = 'bg') {
  const siteUrl = 'https://www.avtovia.bg';
  const content = {
    bg: {
