 ...
 */
export function getGovernmentServiceSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  const content = {
    bg: {
 ...
 */
export function getVignetteCheckPublicServiceSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  return {
    "@context": "https://schema.org",
    "@type": "PublicService",
 ...
 */
export function getVignetteCheckSoftwareSchema(locale = 'bg', baseUrl = 'https://www.avtovia.bg') {
  const content = {
    bg: {
