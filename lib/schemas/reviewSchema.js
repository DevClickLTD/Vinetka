 ...
 */
export function getReviewSchema(review, productId, baseUrl = 'https://www.avtovia.bg') {
  return {
 ...
 */
export function getProductReviewsSchemas(reviews, productId, baseUrl = 'https://www.avtovia.bg') {
