 ...
 */
export function getReviewSchema(review, productId) {
 ...
 */
export function getProductReviewsSchemas(reviews, productId) {
  return reviews.map(review => getReviewSchema(review, productId));
}
