 ...
 */
export function getReviewSchema(review, productId, domain = 'avtovia') {
 ...
 */
export function getAggregateRatingSchema(ratingData, productId, domain = 'avtovia') {
  const siteUrl = getSiteUrl(domain);
  return {
 ...
 */
export function getProductReviewsSchemas(reviews, productId, domain = 'avtovia') {
  return reviews.map(review => getReviewSchema(review, productId, domain));
}
