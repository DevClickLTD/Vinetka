 ...
 */
export function getReviewSchema(review, productId, baseUrl = 'https://www.vinetka.bg') {
  return {
 ...
 */
export function getProductReviewsSchemas(reviews, productId, baseUrl = 'https://www.vinetka.bg') {
