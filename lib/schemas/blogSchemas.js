 ...
 */
export function getBlogPostingSchema(post, locale = 'bg', baseUrl = 'https://vinetka.bg') {
 ...
 */
export function getBlogSchema(locale = 'bg', baseUrl = 'https://vinetka.bg') {
  return {
    "@context": "https://schema.org",
    "@type": "Blog",
    "@id": `${baseUrl}/${locale}/blog#blog`,
 ...
 */
export function getBlogListingSchema(posts, currentPage, totalPages, locale = 'bg', baseUrl = 'https://vinetka.bg') {
  return {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
