 ...
 */
export function getBlogPostingSchema(post, locale = 'bg', baseUrl = 'https://www.vinetka.bg') {
  ...
  return {
    ...
    "author": {
      "@type": "Person",
      "name": post.author_name || "Vinetka.bg Team",
      "url": `${baseUrl}/${locale}/za-nas`,
      "image": {
        "@type": "ImageObject",
        "url": post.author_avatar || `${baseUrl}/vinetka.bg-logo.png`
      }
    },
    "publisher": {
      "@type": "Organization",
      ...
      "logo": {
        "@type": "ImageObject",
        "url": `${baseUrl}/vinetka.bg-logo.png`,
        "width": 250,
        "height": 60
      }
    },
    ...
    "isPartOf": {
      ...
      "name": locale === 'bg' ? "Блог Vinetka.bg" : "Vinetka.bg Blog",
 ...
 */
export function getBlogSchema(locale = 'bg', baseUrl = 'https://www.vinetka.bg') {
  return {
    "@context": "https://schema.org",
    "@type": "Blog",
    "@id": `${baseUrl}/${locale}/blog#blog`,
    "url": `${baseUrl}/${locale}/blog`,
    "name": locale === 'bg' ? "Блог Vinetka.bg - Новини и съвети за винетки" : "Vinetka.bg Blog - Vignette News and Tips",
 ...
 */
export function getBlogListingSchema(posts, currentPage, totalPages, locale = 'bg', baseUrl = 'https://www.vinetka.bg') {
  return {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
