      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl font-display mb-6">
            Регистрирай се безплатно и управлявай своите винетки на едно място
          </h2>
          <p className="mt-4 text-lg leading-8 text-purple-100">
            Следи датите на изтичане, получавай напомняния навреме и пътувай без притеснения.
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 text-white">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold">Проверка на валидност</h3>
              <p className="text-sm text-purple-100 mt-1">До кога е активна всяка винетка</p>
            </div>
            <div className="flex flex-col items-center">
              <svg className="h-12 w-12 mb-3 text-purple-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
              </svg>
              <h3 className="text-lg font-semibold">Напомняния</h3>
              <p className="text-sm text-purple-100 mt-1">Навреме за изтичащи винетки</p>
            </div>
            <div className="flex flex-col items-center">
              <svg className="h-12 w-12 mb-3 text-purple-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <h3 className="text-lg font-semibold">Бърза поръчка</h3>
              <p className="text-sm text-purple-100 mt-1">Подновяване с няколко клика</p>
            </div>
          </div>
        </div>
      </div>
