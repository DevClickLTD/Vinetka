...
//               <Link
//                 href="/services"
//                 className="rounded-md bg-[#803487] hover:bg-gray-300 hover:text-[#000000] px-3 py-2 text-sm font-semibold text-black shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
//               >
//                 Услуги
//               </Link>
//               <Link
...
//                       <Link
//                         href="/blog"
//                         className="font-semibold whitespace-nowrap text-[#803487]"
//                       >
...
//                     <Link
//                       href="/services"
//                       className="rounded-md text-[#000000] bg-[#803487] hover:bg-gray-300 hover:text-[#000000] px-3.5 py-2.5 text-sm font-semibold text-black shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
//                     >
//                       Услуги
//                     </Link>
//                     <Link
