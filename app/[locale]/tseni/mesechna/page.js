...
import MonthlyVignetteExpandable from '../../../../components/MonthlyVignetteExpandable';
import { 
  FaCalendarAlt, 
  FaCheckCircle, 
  FaClock,
...
export default async function MesechnaVignette({ params }) {
  ...
  // ✅ Product Schema
  const productSchema = getVignetteProductSchema('monthly', locale, 'avtovia');
  const features = [
    {
  ...
  return (
    <>
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              ...
              <div className="inline-flex flex-col items-center rounded-lg bg-white px-6 py-3">
                <span className="text-2xl font-bold text-purple-900">15,34 €</span>
      ...
      {/* Monthly Vignette Expandable Section */}
      <MonthlyVignetteExpandable />
